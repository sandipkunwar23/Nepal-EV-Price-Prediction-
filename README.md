Nepal has experienced a rapid rise in electric vehicle (EV) adoption in recent years. According to The New York Times, electric vehicles accounted for around 70–76% of new passenger vehicle sales in Nepal during 2024–25, making it one of the fastest EV adoption rates globally. This growth is driven by favorable import policies, low electricity costs from hydropower, and expanding charging infrastructure.
...
Methodology:
   1. Data collected using Selenium WebDriver.
   2. Scraped data stored as a CSV file.
   3. CSV imported for analysis and visualization.
